...
import EduTechSection from "@/components/ui/EduTechSection";
import Footer from "@/components/ui/Footer";
import ContactModal from "@/components/ui/ContactModal";

const EduTechCanvas = dynamic(
  () => import("@/components/canvas/EduTechCanvas"),
  { ssr: false }
);
...
export default function EduTechPage() {
  ...
  return (
    <main className="relative min-h-screen bg-[#040507] text-[#F2F4F8] overflow-x-hidden">
      <CustomCursor />
      <EduTechCanvas scrollProgress={scrollProgress} />
      <Navigation onOpenContact={() => setIsContactOpen(true)} />

      <div className="pt-28">
        <EduTechSection onOpenContact={() => setIsContactOpen(true)} />
      </div>
